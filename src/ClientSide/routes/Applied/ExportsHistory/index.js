...
import CustomFilter from '../../table/routes/data/Components/ExportsHistory';
...
class BasicTables extends React.Component {
    componentDidMount(){
        ...
        $("#exports").addClass("active-menu");

        document.title = "Exports History";
...
import OrderTable from '../../../../components/dashboard/eCommerce/OrderTable';
import IntlMessages from '../../../../util/IntlMessages';
import DocumentsTable from '../../table/routes/data/Components/ExportsHistory';
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="jr-card">
                                    <div className="jr-card-header d-flex align-items-center">
                                        {/!*<h3 className="mb-0">Exports History</h3>*!/}
                                        <div className="ml-3">
                                        </div>
                                    </div>
                                    <DocumentsTable/>
