...
const users = [
    {image: 'http://via.placeholder.com/150x150', phone: 'jhonsmith@example.com'},
    {image: 'http://via.placeholder.com/150x150', phone: 'stella02@example.com'},
    {image: 'http://via.placeholder.com/150x150', phone: 'chrris0254@example.com'}];
