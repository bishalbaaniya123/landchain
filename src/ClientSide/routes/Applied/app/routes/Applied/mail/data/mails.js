export default [

    {
        ...
        'from': {
            ...
            'phone': 'domnicharris@example.com'
        },
        'to': [
            {
                'name': 'me',
                'phone': 'robert.johnson@example.com'
            }, {
                'name': 'me',
                'phone': 'robert.johnson@example.com'
            }
    ...
    },
    {
        ...
        'from': {
            'name': 'Garry Sobars',
            'avatar': 'http://via.placeholder.com/150x150',
            'phone': 'danielleobrien@example.com'
        },
        'to': [
            {
                'name': 'me',
    ...
    },
    {
        ...
        'from': {
            'name': 'Stella Johnson',
            'avatar': 'http://via.placeholder.com/150x150',
            'phone': 'stella-johnson@example.com'
        },
        'to': [
            {
                'name': 'me',
