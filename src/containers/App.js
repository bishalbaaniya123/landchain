...
import ClientApp from 'ClientSide/index';
...
class App extends Component {
    ...
    render() {
        ...
        if (location.pathname === '/') {
            return (<Redirect to={'/client/redirect-google'}/>);
        } else if (location.pathname === '/admin' || location.pathname === '/admin/') {
            return (<Redirect to={'/admin/sample-page'}/>);
        }
        ...
        return (
            ...
            >
                <div className="app-main">
                    <Switch>
                        <Route path={`${match.url}client`} component={ClientApp}/>
