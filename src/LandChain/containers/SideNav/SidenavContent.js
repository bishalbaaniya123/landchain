            ...
            <CustomScrollbars className="scrollbar" style={{height: 'calc(100vh - 70px)'}}>
                <ul className="nav-menu">
                    ...
                    <li className="new-menu">
                        <a href="javascript:void(0)" onClick={() => this.redirectToPage("users")}
                           id="users-tab" className="users"
                        >
                    ...
                    <li className="new-menu">
                        <a href="javascript:void(0)" onClick={() => this.redirectToPage("land")}
                           id="plans-main-button-menu" className="land"
                        >
