...
class SamplePage extends React.Component {
    ...
    componentDidMount() {
        ...
        $("#plans-main-button-menu").addClass("active-menu");
    ...
    handleHaltTransaction = () => {
        let body = {
            land_uuid: this.props.landUuid,
            is_halted: !this.props.isHalted
        };
        api.haltTransaction(body)
            .then((res) => {
                this.setState({
                    showConfirmHalt: false,
                    showSuccessfulHalt: true
                })
            });
    };
    ...
    render() {
        ...
        return (
            ...
            <div className={`app-container ${drawerStyle}`}>
                            ...
                            <div className="app-wrapper">
                                <div className="animated slideInUpTiny animation-duration-3">
                                    <Button onClick={this.goBack} color="primary"
                                            style={{marginLeft: "17px", marginBottom: "15px"}}>Back</Button>
                                    {this.props.isHalted ?
                                        <Button onClick={() => {
                                            this.setState({
                                                ...
                                                color="success"
                                                style={{marginLeft: "17px", marginBottom: "15px", float: 'right'}}>
                                    ...
                                    <CardBox styleName="col-12" cardStyle="p-0 overflow-hidden"
                                             heading={"Land Details - " + this.props.landUuid}
                                             headerOutside>
                                        {this.props.isHalted ?
                                            <p style={{color: 'indianred', marginTop: 15}}>This land is currently
                                                halted. Unhalt this land to carry out operations.</p>
                                            :
                                            null
                                        }
                                        <div className="row">
                ...
                <SweetAlert show={this.state.showConfirmHalt}
                            custom
                            showCancel
                            confirmBtnText="Yes"
                            cancelBtnText="No"
                            ...
                            title={<p className="sweet-alert-title">
                                Are you sure you want to {this.props.isHalted ? 'unhalt' : 'halt'} this land?
                            </p>}

                            onConfirm={this.handleHaltTransaction}
                            onCancel={() => {
                                this.setState({
                                    showConfirmHalt: false
                                })
                ...
                <SweetAlert show={this.state.showSuccessfulHalt} success
                    ...
                    Land has been {this.props.isHalted ? 'unhalted' : 'halted'} successfully
                </SweetAlert>
...
const mapStateToProps = (state) => {
    ...
    return {
        ...
        landTransactionId: state.selfReducers.landTransactionId
    }
};
