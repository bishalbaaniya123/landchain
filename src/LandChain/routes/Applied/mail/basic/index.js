...
import CardBox from "app/routes/Applied/Users";
import $ from "jquery";
...
class Mail extends Component {
    ...
    componentDidMount() {
        ...
        $("#support-main-button-menu").addClass("active-menu");
                                                        ...
                                                        <i className="zmdi zmdi-check zmdi-hc-lg"/>
                                                            ...
                                                            <Dropdown isOpen={optionMenuState}
                                                                ...
                                                                <DropdownToggle tag="span"
                                                                                caret>
                                                                    <span
                                                                        className="px-2"> {this.state.optionName}</span>
                                                                </DropdownToggle>
...
const mapStateToProps = ({settings}) => {
    ...
    return {width, drawerType, navigationStyle, horizontalNavPosition}
};
