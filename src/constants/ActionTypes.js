...
// self_actions
export const SAVE_DETAILS_OF_ME = 'save_details_of_me';
export const SAVE_CURRENT_LAND_TRANSACTION_ID = 'save_current_land_transaction_id';
export const SAVE_CURRENT_LAND_HALTED = 'save_current_land_halted';
export const SAVE_SERVER_TOKEN = 'save_server_token';
export const LOGOUT = 'logout';
export const ADMIN_LOGOUT = 'admin_logout';
export const SAVE_ADMIN_TOKEN = 'save_admin_token';
export const SAVE_IS_ONGOING_TRANSACTION = 'save_is_ongoing_transaction';
export const SAVE_LAND_OWNER_DETAILS = 'save_land_owner_details';
export const IS_FREE_TRIAL_PLAN = 'is_free_trial_plan';
// end self_actions

//landChain Actions
export const CURRENT_LAND_UUID = 'current_land_uuid';
export const CURRENT_LAND_LOCATION = 'current_land_location';
//landChain Actions
